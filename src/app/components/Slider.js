export default function Slider(props){
    ...
    function up(){
        props.count === 3 ? props.funcChange(1) : props.funcChange(props.count + 1)
    }
    function down(){
        props.count === 1 ? props.funcChange(3) : props.funcChange(props.count - 1)
    }

    return(
        <div class='flex justify-between h-1/2 items-end text-white font-Acrom_light px-10'>
            <div class='flex items-center relative' onClick={down}>
            ...
            <div class='flex items-center relative' onClick={up}>
