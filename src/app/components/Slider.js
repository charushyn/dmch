export default function Slider(props){
    ...
    return(
        <div class='flex justify-between h-1/2 items-end text-white font-Acrom_light px-10'>
            <div class='flex items-center relative pointer-events-auto right-0 hover:right-2 transition-all' onClick={down}>
            ...
            <div class='flex items-center relative pointer-events-auto left-0 hover:left-2 transition-all' onClick={up}>
