...
export default function Quote(props){
    return(
        <div class='w-[36rem] max-h-[14rem] bg-bgblack font-Acrom_light flex-col px-14 py-10 md:w-full md:mt-8 md:text-right'>
            ...
            <div class='text-gold flex gap-3 relative justify-end mt-4 pointer-events-auto cursor-pointer hover:gap-1 duration-300' onClick={() => props.toConsultation()}>
