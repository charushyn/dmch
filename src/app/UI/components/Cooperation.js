export default function Cooperation(props){
    return(
        <div class='flex font-Acrom_light'>
            <div class='bg-friends w-1/2 bg-center bg-cover h-[40rem]'></div>
            <div class='bg-light_gold flex-col w-1/2 px-20 relative pt-48 lg:pt-20 lg:px-16'>
                    ...
                    <div onClick={props.onSuccess} class='text-gold bg-bgblack w-[17.5rem] h-[4rem] flex justify-between px-6 items-center mt-16 cursor-pointer hover:bg-gold hover:text-bgblack duration-300'>
