                ...
                {services.map((service) => {
                    ...
                    return(
                        <li>
                            <div onClick={() => {
                                setHidden(!hidden)
                                }} id={service.id} class={`border-b-2 border-light_gold border-opacity-50 mx-10 h-[4rem] flex justify-between items-center group cursor-pointe ${hidden ? '' : 'border-none'}`}>
                            ...
                            {hidden ? '' :
                                <div class={`my-4 flex border-b-2 border-light_gold border-opacity-50 pb-8 w-fit mx-10`}>
                                    <div class='mx-auto flex flex-col justify-between'>
                                        <img src={service.detailPhoto} class='inline-block md:w-full md:h-[10rem] md:object-cover md:object-center'></img>
